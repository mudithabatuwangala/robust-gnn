...
# Stratified mix, pooling method, activation, same hidden layers - Kep them as it is but change the model to GAT
# Use early stopping based on the vavlidation loss. Not based on the accuracy.